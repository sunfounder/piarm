...
访问下载页面：https://www.raspberrypi.org/software/。 单击与你的操作系统匹配的 Raspberry Pi Imager 链接，下载完成后，单击它以启动安装程序。
...
当你启动安装程序时，你的操作系统可能会尝试阻止你运行它。 例如，在 Windows 上，我收到以下消息：
...
按 **Ctrl+Shift+X** 打开 **高级选项** 页面启用SSH和配置wifi，这2项必须设置，其他取决于你的选择。 你可以选择始终使用此图像自定义选项。
...
如果你的 SD 卡上当前有任何文件，你可能希望先备份这些文件以防止永久丢失它们。 如果没有要备份的文件，请单击 **YES**。
