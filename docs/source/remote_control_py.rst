...
* 按下键盘上的 ``w`` 键， ``alpha`` 角度增加，让手臂向前伸。
* 按下键盘上的 ``s`` 键， ``alpha`` 角度减小，让手臂向里缩。
* 按下键盘上的 ``a`` 键， ``gamma`` 角度增加，让手臂向左转动。
* 按下键盘上的 ``d`` 键， ``gamma`` 角度减小，让手臂向右转动。
* 按下键盘上的 ``i`` 键， ``beta`` 角度增加，让手臂向上。
* 按下键盘上的 ``k`` 键， ``beta`` 角度减小，让手臂向下。
